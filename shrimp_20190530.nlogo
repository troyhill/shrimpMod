...
to setup
  ...
  set salinity.data     gis:load-dataset "/opt/physical/troy/NetLogo 6.0.2/Projects/BISC_shrimp/BISC_GIS/salinity_2016.asc"
  set temperature.data  gis:load-dataset "/opt/physical/troy/NetLogo 6.0.2/Projects/BISC_shrimp/BISC_GIS/temperature_2016.asc"
...
to load-salinity-temperature
  ...
  ask patches with [ salinity > -1 ] [
    ...
    set daily-survival e ^ (-1 * M1) ; daily probability of survival?
  ]
end

to setup-datetime
  set t-datetime time:create "2013-01-01 00:00"
  set t-date time:create "2013-01-01"
...
;------------------------------------------------------------------------------
  ...
  [
    let yr time:get "year" tick-date
    set salinity.data     gis:load-dataset (word "/opt/physical/troy/NetLogo 6.0.2/Projects/BISC_shrimp/BISC_GIS/salinity_" yr ".asc" )
    set temperature.data  gis:load-dataset (word "/opt/physical/troy/NetLogo 6.0.2/Projects/BISC_shrimp/BISC_GIS/temperature_" yr ".asc" )
    load-salinity-temperature
  ]
end
